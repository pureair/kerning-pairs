...
rightside_groups_cap = group_letters(letters_cap, 1)
print("Group by Rightside:")
print("========================================")
print("")
print_groups(rightside_groups_cap)
...
leftside_groups_cap = group_letters(letters_cap, 0)
print("Group by Leftside:")
print("========================================")
print("")
print_groups(leftside_groups_cap)
...
print("========================================")
list_combinations(leftside_groups_cap, rightside_groups_cap)
print("")
list_combinations(leftside_groups_cap, rightside_groups)
print("")
list_combinations(leftside_groups, rightside_groups_cap)
print("")
